...
from net.resnet12 import ResNet12
...
def main():
    ...
    feature_encoder = ResNet12([64, 128, 256, 512])
    ...
    if os.path.exists(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_blend_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_blend_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load feature encoder success")
    if os.path.exists(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_blendnet_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
...
#         print('sample_feature', sample_features.shape, 'batch_features', batch_features.shape)
        ...
        bc_f1_ext = bco_f1.unsqueeze(0).repeat(SAMPLE_NUM_PER_CLASS*CLASS_NUM,1,1,1,1)
        ...
        bc_f2_ext = bco_f2.unsqueeze(0).repeat(SAMPLE_NUM_PER_CLASS*CLASS_NUM,1,1,1,1)
        ...
        bc_f3_ext = bco_f3.unsqueeze(0).repeat(SAMPLE_NUM_PER_CLASS*CLASS_NUM,1,1,1,1)
        ...
        bc_f4_ext = bco_f4.unsqueeze(0).repeat(SAMPLE_NUM_PER_CLASS*CLASS_NUM,1,1,1,1)
        ...
        if episode%5000 == 0:
            ...
            for i in range(TEST_EPISODE):
                ...
                for test_images,test_labels in test_dataloader:
                    ...
                    ts_f1_ext = tso_f1.unsqueeze(0).repeat(1*CLASS_NUM, 1, 1, 1, 1)
                    ...
                    ts_f2_ext = tso_f2.unsqueeze(0).repeat(1*CLASS_NUM, 1, 1, 1, 1)
                    ...
                    ts_f3_ext = tso_f3.unsqueeze(0).repeat(1*CLASS_NUM, 1, 1, 1, 1)
                    ...
                    ts_f4_ext = tso_f4.unsqueeze(0).repeat(1*CLASS_NUM, 1, 1, 1, 1)
