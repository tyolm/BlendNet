...
import omniglot.task_generator as tg
...
def main():
    ...
    if os.path.exists(str("/content/drive/MyDrive/miniimagenet_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("/content/drive/MyDrive/miniimagenet_feature_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load feature encoder success")
    if os.path.exists(str("/content/drive/MyDrive/miniimagenet_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        relation_network.load_state_dict(torch.load(str("/content/drive/MyDrive/miniimagenet_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
    ...
    for episode in range(EPISODE):
        ...
        print(batches.shape, batch_labels.shape)
        ...
        print('batch_labels', batch_labels.shape, batch_labels)
