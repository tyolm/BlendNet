...
def main():
    ...
    feature_encoder = ResNet12([64, 160, 320, 640])
    ...
    if os.path.exists(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_aug_blend_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
        feature_encoder.load_state_dict(torch.load(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_aug_blend_encoder_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
        print("load feature encoder success")
    if os.path.exists(str("D:\nut\code\blendnet_win\model\miniimagenet\mini_res_aug_blendnet_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
